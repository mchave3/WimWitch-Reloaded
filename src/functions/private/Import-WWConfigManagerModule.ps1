...
.NOTES
    Name:        Import-WWConfigManagerModule.ps1
...
#>
function Import-WWConfigManagerModule {
    [CmdletBinding()]
    [OutputType([bool])]
    param(
    ...
    process {
        try {
            ...
            Write-WimWitchLog -Data 'ConfigMgr PowerShell module imported' -Class Information
            return $true
        }

        catch {
            Write-WimWitchLog -Data 'Could not import CM PowerShell module.' -Class Warning
            return $false
        }
    }
}
