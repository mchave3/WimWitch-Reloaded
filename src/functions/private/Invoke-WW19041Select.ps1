...
'@
        ...
        $WPFWin10PUCancel.Add_Click({
                ...
                Write-WimWitchLog -data 'User cancelled the confirmation dialog box' -Class Warning
                $Form.Close()
                return
            })
