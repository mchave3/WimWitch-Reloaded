...
.DESCRIPTION
    This function updates the Windows version combo box with appropriate versions
    based on the selected operating system (Windows Server, Windows 10, or Windows 11).
