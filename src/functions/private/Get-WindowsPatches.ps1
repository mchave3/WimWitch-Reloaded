...
.DESCRIPTION
    This function is used to get OS updates for a specific OS and build. It will download SSU, AdobeSU, LCU, .Net, .Net CU, optional and dynamic updates for the specified OS and build.
